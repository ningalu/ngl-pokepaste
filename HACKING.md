...
hidden if the `ngl-pokepaste_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ngl-pokepaste_DEVELOPER_MODE` to the configure
