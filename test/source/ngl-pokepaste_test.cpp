...
#define CHECK_EQ(lhs, rhs)                                                                  \
  if (!(lhs == rhs)) {                                                                      \
    std::cout << "Test failure at line " << std::source_location::current().line() << "\n"; \
  }
...
auto main() -> int {
  ...
  {
    {
      const auto trim1 = ngl::pokepaste::util::trim(" abc ");
      assert((trim1 == "abc"));
    }

    {
      const auto ends_value    = "ends with";
      const auto ends_result   = ngl::pokepaste::util::ends_with(ends_value, "with");
...

    {
      ...
      const auto contains_result   = ngl::pokepaste::util::contains(contains_value, "ta");
    ...
    {
      const auto contains_value    = "contains";
      const auto contains_result   = ngl::pokepaste::util::contains(contains_value, "z");
      const auto contains_expected = false;
      assert((contains_result == contains_expected));
    }

    {
      const auto join_value    = std::vector{std::string{"a"}, std::string{"b"}, std::string{"c"}};
      const auto join_result   = ngl::pokepaste::util::join(join_value);
...

    {
      ...
      const auto join_result   = ngl::pokepaste::util::join(join_value, "1");
      const auto join_expected = std::string{"a"};
      assert((join_result == join_expected));
    }

    {
      const auto split_value    = ngl::pokepaste::util::split("a b c d e f g", " ");
      const auto split_expected = std::vector<std::string>{"a", "b", "c", "d", "e", "f", "g"};
      assert((split_value == split_expected));
    }

    {
      const auto split_value    = ngl::pokepaste::util::split("abc", " ");
      const auto split_expected = std::vector<std::string>{"abc"};
      assert((split_value == split_expected));
    }

    {
      const auto split_value    = ngl::pokepaste::util::split("abbcccbba", "c");
      const auto split_expected = std::vector<std::string>{"abb", "", "", "bba"};
      assert((split_value == split_expected));
      const auto join_value    = ngl::pokepaste::util::join(split_value, "c");
...

    {
      ...
      const auto upper_result   = ngl::pokepaste::util::to_upper(upper_value);
...

    {
      ...
      const auto lower_result   = ngl::pokepaste::util::to_lower(lower_value);
  ...
  {
    {
      ...
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Species", std::nullopt, std::nullopt};
...

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Sp@cies", std::nullopt, std::nullopt};
      CHECK_EQ(name_result, name_expected);
    }

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Species", std::nullopt, "Item"};
      CHECK_EQ(name_result, name_expected);
    }

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Sp@cies", std::nullopt, "Item"};
      CHECK_EQ(name_result, name_expected);
    }

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Species", ngl::pokepaste::Gender::M, "Item"};
      CHECK_EQ(name_result, name_expected);
    }

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Sp@cies", ngl::pokepaste::Gender::M, "Item"};
      CHECK_EQ(name_result, name_expected);
    }

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Species", ngl::pokepaste::Gender::F, "Item"};
      CHECK_EQ(name_result, name_expected);
    }

    {
      ...
      const auto name_result   = ngl::pokepaste::detail::decode_name_line(name_value);
      const auto name_expected = ngl::pokepaste::detail::SpeciesLineInfo{std::nullopt, "Sp@cies", ngl::pokepaste::Gender::F, "Item"};
      CHECK_EQ(name_result, name_expected);
    }
...

    {
      ...
      const auto ability       = ngl::pokepaste::detail::decode_ability_line("Ability: " + ability_value);
...

    {
      ...
      const auto ability_expected = ngl::pokepaste::util::trim(ability_value);
      assert((ability_result == ability_expected));
    }

    {
      const auto level_value    = std::size_t{15};
      const auto level_result   = ngl::pokepaste::detail::decode_level_line("Level:" + std::to_string(level_value));
...

    {
      ...
      try {
        (void)ngl::pokepaste::detail::decode_level_line("Level:" + std::to_string(level_value));
        assert(false);
...

    {
      ...
      const auto shiny_result   = ngl::pokepaste::detail::decode_shiny_line("Shiny:" + shiny_value);
...

    {
      ...
      const auto happy_result   = ngl::pokepaste::detail::decode_happiness_line("Happiness:" + std::to_string(happy_value));
...

    {
      ...
      const auto dmax_result   = ngl::pokepaste::detail::decode_dynamax_level_line("Dynamax Level:" + std::to_string(dmax_value));
...

    {
      ...
      try {
        (void)ngl::pokepaste::detail::decode_gigantamax_line("Gigantamax:" + gmax_value);
        assert(false);
      } catch ([[maybe_unused]] const std::runtime_error &e) {
      }
    }

    {
      ...
      const auto tera1      = ngl::pokepaste::detail::decode_tera_type_line("Tera Type:" + tera_value);
...

    {
      ...
      const auto tera_expected = ngl::pokepaste::util::trim(tera_value);
...

    {
      ...
      const auto nature       = ngl::pokepaste::detail::decode_nature_line("Nature: " + nature_value);
...

    {
      ...
      const auto nature_expected = ngl::pokepaste::util::trim(nature_value);
...

    {
      ...
      const auto move_expected = ngl::pokepaste::util::trim(move_value);
